 ...
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 *  | LALT |LGUI |C-M- |JP_MH|LOWER|                             !RAISE|JP_HE|RALT |JP_LB|JP_RBR|
 *  '------------------------------'                             '------------------------------'
 *                               .---------------. .---------------.
...
[BASE] = LAYOUT_ergodox(
  ...
  KC_LALT,   KC_LGUI,   LCTL(KC_LALT),   JP_MHEN,   MO(LOWER),
                                                         KC_LCTL,   JP_ZHTG,
                                                                    KC_HOME,
 ...
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |       |     |     |     |     |     |-------! !-------!LEFT |DOWN | UP  |RIGHT|JP_YE|JP_RBRC|
 * !-------+-----+-----+-----x-----x-----!       ! !       !-----x-----x-----+-----+-----+-------!
 * |       |     |     |     |     |     |       | !       |     |     |     |     |     |       |
 * '-------+-----+-----+-----+-----+-------------' '-------------+-----+-----+-----+-----+-------'
 *  |      |     |     |     |     |                             !MO(AD|     |     |     |      |
...
[LOWER] = LAYOUT_ergodox(
  ...
  _______,   KC_BRK,    _______,   KC_INS,    KC_SLCK,   KC_PSCR,   KC_F12,
             KC_LEFT,   KC_DOWN,   KC_UP,     KC_RIGHT,  JP_YEN,    JP_RBRC,
  _______,   _______,   _______,   _______,   _______,   _______,   _______,
